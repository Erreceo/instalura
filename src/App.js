        ...
        <div data-reactroot className="main">
          <header className="header container">
            ...
            <form lpformnum={1} className="header-busca">
              <input type="text" name="search" placeholder="Pesquisa" className="header-busca-campo" /><input type="submit" defaultValue="Buscar" className="header-busca-submit" />
            </form>
            <nav>
            ...
            <div className="foto">
              ...
              <section className="fotoAtualizacoes">
                ...
                <form className="fotoAtualizacoes-form">
                  ...
                  <input type="submit" defaultValue="Comentar!" className="fotoAtualizacoes-form-submit" />
                </form>
              </section>
            </div> {/*fim .foto*/}
            <div className="foto">
